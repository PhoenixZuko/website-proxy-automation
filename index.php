...
<head>
    ...
    <title>Dynamic Content Panel</title>
...
<body>
    ...
    <div class="container">
        <div class="dynamic-panel" id="main-content">
    <h2>Welcome to Proxy Site </h2>
    <p>Explore the best proxies and manage your connections efficiently!</p>
    
</div>
<div class="documentation-panel">
    <a href="documentation_en.html" class="btn">Documentation (English)</a>
    <a href="documentation_ro.html" class="btn">Documentație (Română)</a>
</div>
